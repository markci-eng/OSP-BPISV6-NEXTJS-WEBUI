...
// ARCHIVED — no route. This was the original `/claims/death-claim`: a
// dashboard of queue sections with the claim opened somewhere else. The
// Conveyor answers the same brief claim-first and holds that route now.
//
