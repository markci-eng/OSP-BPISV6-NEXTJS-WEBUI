...
// The queue's second-tier filters — territory and benefit — behind one button.
//
 ...
 * button in the first place. What it does carry is a COUNT: with anything
 * ticked, a badge says how many, because a collapsed filter that is quietly
 * narrowing the queue is the one way this pattern misleads. Ticked, the button
 * also takes the green ring the rest of the area uses for "on".
 */
export function DeathClaimsMoreFilters({
  groups,
  ...rest
}: {
  groups: FilterGroup[];
...
export default DeathClaimsMoreFilters;
