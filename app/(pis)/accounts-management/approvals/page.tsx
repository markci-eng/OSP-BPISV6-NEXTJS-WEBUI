...
import { ApprovalView } from "./data/types";
...
const APPROVAL_TYPES: { label: string; value: ApprovalView }[] = [
  ...
  { label: "Transfer Of Rights", value: "transfer-of-rights" },
  { label: "Plan Termination", value: "plan-termination" },
  { label: "Cash Surrender Value (CSV)", value: "csv" },
  { label: "Certificate Of Full Payment (COFP)", value: "cofp" },
...
export default function page() {
  const [view, setView] = useState<ApprovalView>("rop");
