...
import { PlanholderInfoProps } from "@/components/plan-management/planholder-profile/sections/planholder-info";
import { Address } from "@/components/plan-management/planholder-profile/sections/address-info";
...
export default async function Page({
  ...
  const planholderProfileData: PlanholderPageProps = {
    hyperlinks: {
      payMyPlan: `/accounts-management/planholder-profile/${personId}/pay-my-plan`,
      returnedOfPremium: `/accounts-management/planholder-profile/${personId}/rop`,
      claimApplication: `/accounts-management/planholder-profile/${personId}/claim-application`,
      changeOfMode: `/accounts-management/planholder-profile/${personId}/change-of-mode`,
      cashSurrenderedValue: "/",
      transferOfRights: `/accounts-management/planholder-profile/${personId}/transfer-of-rights`,
      reinstement: `/accounts-management/planholder-profile/${personId}/reinstate-plan`,
      loanApplication: `/accounts-management/planholder-profile/${personId}/loan`,
    },
    planholderInfo: {
      personId,
