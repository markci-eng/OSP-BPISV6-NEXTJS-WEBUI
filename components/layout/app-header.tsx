    ...
    >
      ...
      <Flex align="center" gap={2}>
        <IconButton
          ...
          size="sm"
          variant="ghost"
          onClick={() => window.dispatchEvent(new CustomEvent("osp-start-page-tour"))}
        >
          <LuCircleHelp />
        </IconButton>
        ...
        {isMobile ? (
          <Dialog.Root size="full" motionPreset="slide-in-bottom">
            <Dialog.Trigger asChild>
              <Box position="relative">
                <IconButton color="gray.fg" aria-label="Notifications" size="sm" variant="ghost">
                  <LuBell />
                </IconButton>
                {unreadCount > 0 && (
                  <Badge
                    bg="#ef4444" color="white" borderRadius="full" fontSize="xs"
                    position="absolute" top="0" right="0"
                    minW="4" h="4" display="flex" alignItems="center" justifyContent="center"
                  >
                    {unreadCount}
                  </Badge>
                )}
          ...
          >
            <Popover.Trigger asChild>
              <Box position="relative">
                <IconButton
                  color="gray.fg" aria-label="Notifications" size="sm" variant="ghost"
