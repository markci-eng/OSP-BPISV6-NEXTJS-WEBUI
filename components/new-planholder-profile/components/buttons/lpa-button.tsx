        ...
        <Flex direction="column" gap={3}>
          ...
          <Flex align="flex-start" justify="space-between">
            ...
            <Box
              ...
              py="2px"
              borderRadius="full"
              bg={plan.accountStatus === "LAPSED" ? "orange.400" : "whiteAlpha.200"}
              fontSize="xs"
              color="white"
              fontWeight="semibold"
              letterSpacing="wide"
    ...
    >
      ...
      <Box px={4} pt={3} pb={4}>
        ...
        <Flex align="flex-start" justify="space-between" gap={2} mb={2}>
          ...
          >
            ...
            <Text
              fontSize="10px"
              fontWeight="semibold"
              color={plan.accountStatus === "LAPSED" ? "orange.600" : "green.600"}
            >
              {plan.accountStatus}
            </Text>
          </Flex>
        ...
        <Text fontSize="xs" color="gray.400" mb={3} lineClamp={1}>
          {plan.mode} · {plan.term} year{plan.term !== 1 ? "s" : ""} · {plan.branch}
        </Text>
