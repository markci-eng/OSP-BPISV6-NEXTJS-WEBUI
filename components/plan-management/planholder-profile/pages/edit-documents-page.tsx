...
const REQUIRED_DOCUMENTS = [
  ...
  },
  {
    ...
    description: "Required if requesting a name change due to marriage.",
    required: false,
  },
  {
      ...
      <VStack align="stretch" gap={5}>
        ...
        >
          ...
          >
            ...
            information update request. Your Branch personnel will review all
            uploaded files before applying any changes.
          </Text>
        </HStack>
